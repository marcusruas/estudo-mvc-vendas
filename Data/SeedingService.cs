...
namespace SalesWebMvc.Data
{
    ...
    {
        private SalesWebMvcContext _contexto;

        public SeedingService(SalesWebMvcContext contexto)
        {
            _contexto = contexto;
        }
        ...
        public void Seed()
        {
            if (_contexto.Department.Any() || _contexto.Seller.Any() || _contexto.SalesRecord.Any())
            {
            ...
            _contexto.Department.AddRange(d1, d2, d3, d4);
            _contexto.Seller.AddRange(s1, s2, s3, s4, s5, s6);
            _contexto.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6,
